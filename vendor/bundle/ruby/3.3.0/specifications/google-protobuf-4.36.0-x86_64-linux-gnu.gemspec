# -*- encoding: utf-8 -*-
# stub: google-protobuf 4.36.0 x86_64-linux-gnu lib

Gem::Specification.new do |s|
  s.name = "google-protobuf".freeze
  s.version = "4.36.0".freeze
  ...
  s.metadata = { "source_code_uri" => "https://github.com/protocolbuffers/protobuf/tree/v4.36.0/ruby" } if s.respond_to? :metadata=
